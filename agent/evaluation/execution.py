"""One isolated H-series execution and bounded evidence projection."""
...
from agent.evaluation.execution_evidence import (
    critical_incidents,
    h2_reporting,
    identity_drift,
)
...
def _run_one(
    ...
    *,
    ...
    report: Any = None
    try:
        with tempfile.TemporaryDirectory(prefix=f"evaluation-{scenario.h_id.lower()}-") as raw_root:

"""Mechanical binding and plan-fidelity projections for H-series attribution."""
...
from agent.evaluation.attribution_decisions import decision_plan, tool_entries
from agent.evaluation.attribution_models import BindingFact, ToolEntry

"""Deterministic adversarial audit for the H-series campaign."""
...
from agent.evaluation.evaluation_identity import candidate_identity
...
def _adversarial_review(scenario: HSeriesScenario, arm: HSeriesArm) -> dict[str, Any]:
    """Build the bounded, per-arm adversarial review record."""
...
def adversarial_audit(repo_root: str | Path) -> dict[str, Any]:
...
__all__ = ["ADVERSARIAL_AUDIT_QUESTIONS", "adversarial_audit"]

...
class RuntimeEventKind(str, Enum):
    ...
    CACHE_HIT = "cache_hit"
    CONTEXT_PRESSURE_DECISION = "context_pressure_decision"
    CONTEXT_PROJECTION_COMPACTED = "context_projection_compacted"
    ...
    ERROR = "error"
    EXECUTION_FRONTIER_PROJECTED = "execution_frontier_projected"
    FINAL = "final"
    ...
    PROGRESS_PLATEAU_CYCLE = "progress_plateau_cycle"
    PROGRESS_RECEIPT_ADVANCED = "progress_receipt_advanced"
    REASONING_BOUNDARY_PLAN_PROPOSED = "reasoning_boundary_plan_proposed"
    REPLAN = "replan"
    REPLAN_BLOCKED = "replan_blocked"
    CONVERGENCE_REPLAN_REQUESTED = "convergence_replan_requested"
    CONVERGENCE_REPLAN_DENIED = "convergence_replan_denied"
    ROUTE_TRANSITION = "route_transition"
    GRAPH_AUTHORITY_PREFLIGHT = "graph_authority_preflight"
    MUTATION_SUBSET_CHECKED = "mutation_subset_checked"
    CONSTRAINT_COMPLETION_CHECKED = "constraint_completion_checked"
    SEMANTIC_GROUNDING = "semantic_grounding"
    SEMANTIC_INTENT_PARSED = "semantic_intent_parsed"
    SEMANTIC_INTENT_ADMITTED = "semantic_intent_admitted"
    SEMANTIC_INTENT_ADMISSION_DENIED = "semantic_intent_admission_denied"
    ...
    TASK_DIRECTIVE_SELECTED = "task_directive_selected"
    ...
    OBSERVATION_REUSE = "observation_reuse"
    OBSERVATION_REHYDRATION = "observation_rehydration"
    NO_PROGRESS_PLATEAU_TERMINAL = "no_progress_plateau_terminal"

...
PLANNING_GUIDANCE = (
    ...
    "focadas; não enumere módulos especulativos nem repita discovery ampla. "
    "Uma análise de diretório não substitui automaticamente a observação de "
    "um descendente específico. code_analyzer com compact=true "
